        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
                    ...
                    children: [
                      ...
                      Row(
                        children: [
                          ...
                          ChoiceChip(
                            ...
                            disabledColor: Colors.grey[900],
                            labelStyle: TextStyle(
                              color: _selectedRole == 'admin' ? Colors.white : Colors.grey,
                              fontWeight: FontWeight.bold,
                              fontSize: 12,
                            ),
                            backgroundColor: const Color(0xFF0D0D0D),
                      ...
                      SizedBox(
                        ...
                        child: ElevatedButton.icon(
                          ...
                          onPressed: _isLoading ? null : _authorizeEmail,
                          icon: _isLoading
                              ? const SizedBox(
                                  width: 20,
                                  height: 20,
              ...
              // Listado de Correos Autorizados
              Expanded(
                child: StreamBuilder<List<Map<String, dynamic>>>(
                  stream: _dbService.getAuthorizedEmails(),
