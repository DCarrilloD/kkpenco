...
/**
 * Iconos de consistencia dibujados con Canvas nativo (bitmaps de 128 px).
 * Compartidos por todos los widgets de escritorio; extraído de
 * PoopWidgetProvider sin cambios de dibujo.
 */
object PoopIconDrawer {
    fun draw(consistency: String): Bitmap {
        val size = 128
