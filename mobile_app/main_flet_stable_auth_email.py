...
def main(page: ft.Page):
    ...
    def view_login():
        ...
        def handle_login(e):
            ...
            if res:
                ...
                page.snack_bar = ft.SnackBar(ft.Text(f"Bienvenido, {res['username']}!"))
    ...
    def view_cos():
         ...
         # Members List
         members_list = ft.Column(scroll=ft.ScrollMode.AUTO, spacing=10)
                     ...
                     for u in users:
                         ...
                         members_list.controls.append(
                             ft.Container(
                                 ...
                                 border_radius=10,
                                 content=ft.Row([
                                     ft.Icon(ft.icons.PERSON, color=ACCENT_COLOR if is_me else "grey"),
